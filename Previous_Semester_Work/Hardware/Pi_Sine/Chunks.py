...
if __name__ == '__main__':
    ...
    while True :
        ...
        for i in range(sample_len)  : 
            sample = Volume * math.sin(2*math.pi*(t_idx*freq/sr))
...
#
#  Use this write to limit the size of a file if you redirect stdout to a file
#
#       write_raw_stdout(dat_array)
#       if t_idx > 100000 :  # Be careful!  You get very large files quickly
#          exit()
